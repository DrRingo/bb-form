...
loai_ve* = SelectBox(
  ...
  | options = Tham dự trực tiếp, Xem trực tuyến, Chỉ nhận tài liệu
)
...
che_do_an* = SelectBox(
  | question = Chế độ ăn
  | options = Bình thường, Chay, Không ăn
)
{% endif %}
:::
...
{% if (loai_ve == "Tham dự trực tiếp" and can_xe_dua_don == "Có") %}
